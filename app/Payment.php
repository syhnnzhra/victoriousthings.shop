...
class Payment extends Model
{
    ...
    public const PAYMENT_CHANNELS = [
        'credit_card', 'mandiri_clickpay', 'cimb_clicks', 'bca_clickbca', 'bca_clickpay', 'bri_epay', 'echannel', 'permata_va', 'bca_va', 'bni_va', 'other_va', 'gopay', 'indomaret', 'danamon_online','akulaku', 'shopeepay'];

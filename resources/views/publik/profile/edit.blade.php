                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" name="name" class="form-control" value="{{ $data ? $data->name : '' }}">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="date" name="tanggal_lahir" class="form-control" value="{{ $data ? $data->tanggal_lahir : '' }}">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="alamat" class="form-control" value="{{ $data ? $data->alamat : '' }}">
                                    </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <button type="submit" class="brand-button">ubah</button>
                            </div>
                                </div>
                                </div>
                            </div>

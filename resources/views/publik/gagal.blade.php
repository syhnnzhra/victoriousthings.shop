...
<head>
	<title>Second Things - Transaction Failed</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
                    ...
                    <div class="text-center">
                        <p style="color: aliceblue; ">There's something wrong!</p>
                        <p style="color: aliceblue; ">Please contact calliroe@gmail.com</p>
                    </div>
